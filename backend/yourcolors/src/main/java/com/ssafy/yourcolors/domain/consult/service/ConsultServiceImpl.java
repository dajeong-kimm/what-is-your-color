...
public class ConsultServiceImpl implements ConsultService {
    ...
    private String generatePromptForAI(List<AiResponse.Result> results) {
        ...
        return String.format("""
                ...
                아래의 항목들을 JSON 형식의 객체로 반환해줘. 각 항목은 한 문장씩 줄바꿈해서 작성하고, 친절한 컨설턴트 말투로 자연스럽게 설명해줘.\n
                JSON의 구조는 다음과 같아:\n
                {\n
                  "personal_color": "<메인 컬러 설명>",\n
                  "assist_colors": [ "<보조 컬러1 설명>", "<보조 컬러2 설명>" ],\n
                  "recommendations": {\n
                    "glasses": {\n
                      "frame": "<어울리는 안경 프레임 추천>",\n
                      "style": "<어울리는 안경 스타일 추천>"\n
                    },\n
                    "accessories": {\n
                      "necklace_earrings": "<어울리는 목걸이 및 귀걸이 추천>",\n
                      "ring_bracelet": "<어울리는 반지 및 팔찌 추천>"\n
                    },\n
                    "perfume": "<퍼스널 컬러에 어울리는 향수 스타일 추천>",\n
                    "clothes": {\n
                      "main": "<메인 옷 컬러 추천>",\n
                      "accent": "<포인트 옷 컬러 추천>"\n
                    }\n
