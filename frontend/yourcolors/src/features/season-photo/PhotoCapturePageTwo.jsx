...
const PhotoCapturePage = () => {
  ...
  const drawSmoothRegion = (ctx, landmarks, indices, color, blur, intensity) => {
    ...
    ctx.moveTo(
      (1 - firstPoint.x) * canvasRef.current.width,
  ...
  const detectFaces = async () => {
    ...
    if (results.faceLandmarks.length > 0) {
      ...
      drawLipRegion(
        ctx,
        landmarks,
        selectedColors.lip.hex || "rgba(0,0,0,0)",
        10,
        0.5
      );
      // 나머지 부위는 기존 방식 사용
      drawSmoothRegion(
        ...
        landmarks,
        LEFT_EYE_SHADOW,
        selectedColors.eye.hex || "rgba(0,0,0,0)",
        10,
        0.5
      );
      drawSmoothRegion(
      ...
      drawSmoothRegion(
        ...
        landmarks,
        LEFT_BLUSH,
        selectedColors.cheek.hex || "rgba(0,0,0,0)",
        10,
        0.5
      );
      drawSmoothRegion(
          ...
          <div className="makeup-colors-overlay">
            <div className="makeup-color-item">
              <div
                ...
                style={{
                  backgroundColor:
                    selectedColors.lip.hex !== "transparent"
                      ? selectedColors.lip.hex
                      : "#f0f0f0",
                }}
              ></div>
            ...
            <div className="makeup-color-item">
              <div
                ...
                style={{
                  backgroundColor:
                    selectedColors.eye.hex !== "transparent"
            ...
            <div className="makeup-color-item">
              <div
                ...
                style={{
                  backgroundColor:
                    selectedColors.cheek.hex !== "transparent"
