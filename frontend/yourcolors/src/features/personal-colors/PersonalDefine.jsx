      ...
      <Largemain>
        <div className="content-container">
          ...
          <p className="description">
            ...
            사람마다 피부의 <strong className="netmarbleB">명도(밝고 어두움)</strong>와 <strong className="netmarbleB">채도(선명함과 탁함)</strong>, 그리고 피부의 기본 <strong className="netmarbleB">색조(웜톤/쿨톤)</strong>가 다르기 때문에, 자신에게 잘 어울리는 색상이 존재합니다.<br />
