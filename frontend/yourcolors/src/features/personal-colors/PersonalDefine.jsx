    ...
    <Background>
      ...
      <Largemain>
        <div className="content-container">
          ...
          개인의 피부톤, 눈동자 색, 머리카락 색과 조화를 이루는 최적의 색상을 의미합니다. <br />사람마다 피부의 <strong>명도(밝고 어두움)</strong>와 <strong>채도(선명함과 탁함)</strong>, 그리고 피부의 기본 <strong>색조(웜톤/쿨톤)</strong>가 다르기 때문에, 자신에게 잘 어울리는 색상이 존재합니다.<br/>
