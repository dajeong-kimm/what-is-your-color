...
const PersonalRecommend = () => {
  ...
  const { cosmetics, fetchCosmetics, fetchMansCosmetics, loading, userPersonalId, personalColorDetails } = useStore();
  ...
  useEffect(() => {
    if (userPersonalId) {
      ...
      const fetchData = async () => {
        ...
        await fetchMansCosmetics(userPersonalId);
      };
      fetchData();
    }
  }, [userPersonalId, fetchCosmetics, fetchMansCosmetics]);
