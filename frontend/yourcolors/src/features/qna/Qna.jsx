...
const QnA = () => {
  const qnaList = [
    ...
    {
      question: "Q. 퍼스널 컬러 진단의 정확도를 높일 수 있는 방법이 있나요?",
      answer: `- **진단 카메라의 가이드 동그라미에 얼굴이 가득 차게 촬영하면 정확도를 높일 수 있어요.**\n- 눈, 코, 입을 동그라미 안에 정확히 위치시키면 진단의 정확도도 높아진답니다.`
    },
    {
      question: "Q. 남성 화장품 추천 기능은 없나요?",
      answer: `- **남성 화장품의 경우 현재 업데이트 예정입니다.**\n- 관심을 가지고 계속 지켜봐주세요!`
    }
  ];
